...
<div class="card">
    <div class="card-header px-3 px-md-9">
        <div class="card-title">
            <h3 class="fw-bolder m-0">{{ wncms_model_word(__('wncms-novels::word.novel_chapter'), 'edit') }}</h3>
        </div>
    </div>

    <div class="collapse show">
        <form class="form" method="POST" action="{{ route('novel_chapters.update', $chapter) }}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
